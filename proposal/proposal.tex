...
where strong expressions are considered to have an element of noncompositionality (including proper names, idioms, etc.)
and weak expressions are considered to be compositional but statistically idiomatic (e.g., \lex{highly recommend(ed)}).

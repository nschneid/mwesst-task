...
\Cref{fig:linkmeasure} in the annex offers an example with two annotations 
...
for competitive ranking of systems.\footnote{All of our measures are micro-averages, 
computed globally over tokens in the corpus 

...
\textbf{COASTAL}\footnote{}
The paper introducing the SST data sets also featured several models to tag unseen data, with various levels of supervision. The models can be accessed via \url{https://github.com/coastalcph/supersense-data-twitter}. The most performant model is a supervised sequential model trained with {\sc Searn} \cite{Daume:ea:09}.
...
Copenhagen (supervised 1st-order discriminative) & \textsc{Tweets} & \# & \# & \#  & \# & \# & \# \\
\end{tabular}

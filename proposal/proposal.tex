...
will be publicly released at \url{http://www.ark.cs.cmu.edu/LexSem/} in time for the task. 
We will make an effort to obtain permission from LDC to redistribute the source text, 
which is from the EWTB.} 
...
and asked to correct the boundaries and supersense labels.\footnote{The supersense-annotated tweets 
...
by limiting their training to the provided resources.\footnote{%

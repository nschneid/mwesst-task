...
For the most part, contemporary approaches to English syntactic parsing 
...
the basic units of \emph{meaning}. For example, consider:
...
For instance, \lex{make\ldots order} can be passivized just like canonical verb--direct object combinations.}
...
and $3/6$ with weak links strengthened to strong links. The respective recall values are $1/1$ and $3/3$. 
Overall $F_1$ is computed as the average of two $F_1$-scores, i.e.~$\tfrac{1}{3} \cdot \tfrac{1}{1}/(\tfrac{1}{3} + \tfrac{1}{1}) + \tfrac{3}{6}\cdot \tfrac{3}{3}/(\tfrac{3}{6}+\tfrac{3}{3}) = 0.58$.}
\label{fig:tagschemes}
\end{figure*}

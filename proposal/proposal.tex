...
%\newcommand{\draftnotice}[0]{\textcolor{red}{\small DRAFT. Please do not redistribute without permission.}\\}
...
Both implement (in Python/Cython) supervised discriminative first-order sequence models, one designed for the 
...
one for the closed condition and one for the open condition (using SemCor)? 
What additional resources are needed for features that we would want to allow for the closed condition?}
...
and other forms of syntactic/semantic annotation and processing for social media text \citep{gimpel-11,owoputi-13,schneider-13-fudg,kong-14,mohit-12}.
...
\textbf{Dirk Hovy}\finalversion{\nss{TODO: normalize bib entries}}
is interested in the varying granularity of lexical semantics. 
He has worked on inducing entity types from text \citep{hovy2011b,Hovy:2014well}, 
as well as various sense disambiguation tasks \citep{tratz2009,hovy2010,hovy2011a}, 
most recently introducing work on supersenses to Twitter \citep{johannsen-14}. 
He has also worked on various aspects of annotation, i.e., the influence of the annotators 
and their quality on data and models \citep{Hovy:ea:13,Fromreide:ea:14,hardcases:2014,Hovy:ea:14,Hovy:ea:14:acl,Plank:ea:14}, 
developing a tool to aggregate over several annotations with varying degrees of reliability.\footnote{\url{http://www.isi.edu/publications/licensed-sw/mace/}}
Dirk works at the University of Copenhagen, but has collaborated extensively and maintains close ties to the NLP groups at USC ISI and CMU.


\textbf{Anders Johannsen}'s research at the University of Copenhagen focuses on developing robust language technology 
that allows us to cross domain and language barriers. 
This has included work on supersense tagging of Twitter \citep{johannsen-14} 
as well as semi-supervised methods for word sense disambiguation \citep{sogaard-10}. 

\textbf{Marine Carpuat} works on computational linguistics, multilingual natural language processing and statistical machine translation. 
She specializes in understanding and exploiting lexical semantics and domain adaptation in the context of MT \citep{carpuat-05,carpuat-07,carpuat-10,carpuat-13a,carpuat-13b,irvine-13}.
She has participated in two SemEval shared tasks \citep{carpuat-semeval13,goutte-14} and 
has ties to the University of Maryland, the National Research Council Canada, Columbia University, and Hong Kong University of Science and Technology. 

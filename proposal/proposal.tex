...
is interested in the varying granularity of lexical semantics. He has worked on inducing entity types from text \citep{hovy2011b,Hovy:2014well}, as well as various sense disambiguation tasks \citep{tratz2009,hovy2010,hovy2011a}, most recently introducing work on supersenses to Twitter \citep{Johannsen2014}. He has also worked on various aspects of annotation, i.e., the influence of the annotators and their quality on data and models \citep{Hovy:ea:13,Fromreide:ea:14,hardcases:2014,Hovy:ea:14,Hovy:ea:14:acl,Plank:ea:14}, developing a tool to aggregate over several annotations with varying degrees of reliability\footnote{\url{http://www.isi.edu/publications/licensed-sw/mace/}}.
Dirk works at the university of Copenhagen, but has collaborated extensively and maintains close ties to the NLP groups at USC's ISI and CMU.
